...
import com.au.cbus.formbuilder.raml.generated.entities.apimatic.referencedata.ReferenceDataAPIClient;
import com.au.cbus.formbuilder.raml.generated.entities.apimatic.referencedata.testing.HttpCallBackCatcher;
...
public class ControllerTestBase {
    ...
    private static ReferenceDataAPIClient client;
     ...
     * @return
     */
    protected static ReferenceDataAPIClient getClient() {
        if(client == null)
            synchronized (clientSync) {
                client = new ReferenceDataAPIClient();
            }
        return client;
    }
}
